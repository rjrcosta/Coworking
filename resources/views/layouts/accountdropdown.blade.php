...
<nav x-data="{ open: false }" class="relative group">
    <x-dropdown align="right"  class="hidden group-hover:block">
        <x-slot name="trigger">
            <button
                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md {{ $color }} bg-transparent   focus:outline-none transition ease-in-out duration-150">
