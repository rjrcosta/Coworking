...
<section class="service d-flex justify-content-center" id="service">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="m-5">
          <h2 class="titleServices m-2 p-2">Why Choose us?</h2>
          <p>
      ...
      <div class="col-lg-4 col-md-6 d-flex justify-content-center">
        <div class="service-item">
          <i class="bi-infinity" aria-hidden="true"></i>
      ...
      <div class="col-lg-4 col-md-6 d-flex justify-content-center">
        <div class="service-item">
          <i class="bi-person-gear" aria-hidden="true"></i>
      ...
      <div class="col-lg-4 col-md-6 d-flex justify-content-center">
        <div class="service-item">
          <i class="bi-credit-card" aria-hidden="true"></i>
          <h3>Easy Payment</h3>
          <p>
      ...
      <div class="col-lg-4 col-md-6 d-flex justify-content-center">
        <div class="service-item">
          <i class="bi-image" aria-hidden="true"></i>
